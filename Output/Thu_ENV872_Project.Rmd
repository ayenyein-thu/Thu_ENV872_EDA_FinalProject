...
Subsequent to the general analysis of political and economic institutions within the countries under study, the following figures illustrate the simple linear relationships between primary dependent and independent variables.
...
Further, the above VIF test results indicate that there is less likely to exhibit multicollinearity between variables as all the values are lower than 5. 
